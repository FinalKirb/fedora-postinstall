...
packages_dnf="gnome-tweaks timeshift vim tldr btop fastfetch cmatrix thunderbird steam libreoffice-base libreoffice-draw nextcloud-client goverlay mangohud vkBasalt gamemode virt-manager qemu wine"
packages_dnf_uninstall="gnome-tour gnome-boxes rhythmbox"
